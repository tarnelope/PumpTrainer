...
public class CircleProgressView extends View
{
    ...
    public CircleProgressView(Context context, AttributeSet attrs)
    {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
    		...
    		try {
    			this.mCircleAttribute.mSubPaintColor = a.getColor(R.styleable.CircleProgressView_slice_color, Color.argb(180, 254, 218, 0));
    		} finally {
    			a.recycle();
    		}
    }
    ...
    class CircleAttribute
    {
        ...
        public int mSubPaintColor = Color.argb(180, 254, 218, 0); //Color of pie slice
        public int mBottomPaintColor=Color.argb(125, 0, 0, 0); //Color of pie base
        public int mMainPaintColor=Color.argb(0, 0, 0, 255);
        public int mPaintWidth = 10; //Stroke width?
        ...
        public void autoFix(int width, int height)
        {
            ...
            int left = CircleProgressView.this.getPaddingLeft();
            int right = CircleProgressView.this.getPaddingRight();
            int top = CircleProgressView.this.getPaddingTop();
            int bottom = CircleProgressView.this.getPaddingBottom();
